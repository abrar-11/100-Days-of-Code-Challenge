               ...
               <div class="md:flex md:justify-between ">
                  <div class="mb-6 md:mb-0">
                     <a href="#hero" class="flex items-center">
                        <img src={logo} class="mr-3 h-8" alt="Techiyon Logo" />
                        <span class="self-center text-2xl font-semibold uppercase whitespace-nowrap dark:text-white">
                           Techiyon
                        </span>
                     </a>
                  </div>
                  <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                     <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                           ...
                           <li class="mb-4">
                              <a href="#productivity" class="hover:underline">
                                 Productivity
                              </a>
                           </li>
                           <li class="mb-4">
                              <a href="#network" class="hover:underline">
                                 Network
                              </a>
                           </li>
                           <li class="mb-4">
                     ...
                     <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                           <li class="mb-4">
                              <a
                                 href="https://github.com/abrar-11"
                           ...
                           <li class="mb-4">
                              <a
                                 href="www.linkedin.com/in/abrar-ahmed-dev"
                                 class="hover:underline"
                              >
                                 LinkedIn
                              </a>
